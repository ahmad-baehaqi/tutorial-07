...
public class FlightController {
    ...
    private String updateFlight(@PathVariable("flightNumb") String flightNumb, @RequestParam("destination") String dest,
            @RequestParam("origin") String ori, @RequestParam("time") Date time) {
        FlightModel flight = flightService.getFlightDetailByFlightNumber(flightNumb).get();
